...
def create_rixmsg_cpp_serialize_function(fields: list) -> str:
    ...
    for field in fields:
        ...
        if value_type == "string":
            if is_dynamic_arr:
                serialize_str += f"serialize_string_vector(dst, offset, {field['name']});\n"
            elif is_static_arr:
            ...
            if is_dynamic_arr:
                serialize_str += f"serialize_number_vector(dst, offset, {field['name']});\n"
            elif is_static_arr:
            ...
            if is_dynamic_arr:
                serialize_str += f"serialize_message_vector(dst, offset, {field['name']});\n"
            elif is_static_arr:
                serialize_str += f"serialize_message_array(dst, offset, {field['name']});\n"
            elif is_map:
                if key_type == "string":
