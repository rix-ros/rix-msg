...
for i in range(len(example.static_array_of_objects)):
    assert (
        example.static_array_of_objects[i].number
        == decoded.static_array_of_objects[i].number
    )
    assert (
        example.static_array_of_objects[i].flag
        == decoded.static_array_of_objects[i].flag
    )
print("Success!")
